...
import bag from './PlpScreen/images/bag1.png';
...
const MainPDP = ({navigation}) => {
  ...
  const handleSearch = async() => {
    ...
    if(checkproductAvailabilityAtPincode && checkproductAvailabilityAtPincode.pincode && checkproductAvailabilityAtPincode.pincode.length>0){
...
const getProgressBarColor = (rating) => {
  ...
  switch (rating) {
    ...
    case 1:
      return "red";
    default:
      return "gray";  // Default color for unknown ratings
  }
};
         ...
         {/* <Text>{`Brand: ${product.brand}`}</Text>
          ...
          <Text>{`Image: ${product.color}`}</Text>  */}
           ...
           <View style={{justifyContent:'center',padding:12,}}>
              <Image source={{ uri: product.imageUrl }} style={{ width: 380, height: 480,marginTop:'10%'}} />
              <View style={{flexDirection:'row',alignItems:'center'}}>
          <TouchableOpacity
            ...
            >              
              ...
              <View style={{width:'84%'}}>
                <Text style={{fontSize:12,backgroundColor:'#e8e6e6',marginLeft:'3%'}}>14 days easy return / excahnge applicable for this product</Text>
              </View>
        ...
        <>
          ...
          product?.sizes.find(size => size.name === "S")?.quantity > 0 ? (
            <>   
                            ...
                            padding:'0.3%',
                            borderRadius: 5,
                            backgroundColor: selectedSizes.includes('S') ? '#00338D' : 'white',
                            alignItems: 'center',
                        ...
                        >
                       <View>
                          <Text style={{ color: selectedSizes.includes('S') ? 'white' : 'black' }}>S</Text>
                       </View>
                      </TouchableOpacity>
...
/>
          ...
          {product?.sizes.find(size => size.name === "M")?.quantity > 0 ? (
            <>   
                            ...
                            padding:'0.3%',
                            borderRadius: 5,
                            backgroundColor: selectedSizes.includes('M') ? '#00338D' : 'white',
                            alignItems: 'center',
                            justifyContent: 'center',  // Center the content vertically and horizontally
                         }}
                        ...
                        >
                       <View>
                          <Text style={{ color: selectedSizes.includes('M') ? 'white' : 'black' }}>M</Text>
                       </View>
                      </TouchableOpacity>
  ...
  <>   
    <TouchableOpacity
      style={{
        ...
        padding:'0.3%',
        borderRadius: 5,
        backgroundColor: selectedSizes.includes('L') ? '#00338D' : 'white',
        alignItems: 'center',
        justifyContent: 'center',
      }}
    ...
    >
      <View>
        <Text style={{ color: selectedSizes.includes('L') ? 'white' : 'black' }}>L</Text>
      </View>
    </TouchableOpacity>
  </>
) : (
  ...
  <>   
    <TouchableOpacity
      style={{
        ...
        padding:'0.3%',
        borderRadius: 5,
        backgroundColor: selectedSizes.includes('XL') ? '#00338D' : 'white',
        alignItems: 'center',
        justifyContent: 'center',
      }}
    ...
    >
      <View>
        <Text style={{ color: selectedSizes.includes('XL') ? 'white' : 'black' }}>XL</Text>
      </View>
    </TouchableOpacity>
  </>
) : (
  ...
  <>   
    <TouchableOpacity
      style={{
        ...
        padding:'0.3%',
        borderRadius: 5,
        backgroundColor: selectedSizes.includes('XXL') ? '#00338D' : 'white',
        alignItems: 'center',
        justifyContent: 'center',
      }}
    ...
    >
      <View>
        <Text style={{ color: selectedSizes.includes('XXL') ? 'white' : 'black' }}>XXL</Text>
      </View>
    </TouchableOpacity>
  </>
) : (
        ...
        />
                ...
                <TouchableOpacity
                  style={{
                   ...
                   marginTop: '4%',
                   marginBottom: '3%',
                   borderWidth: selectedColor.includes('green') ? 2 : 2,
                   borderColor: selectedColor.includes('green') ? 'red' : 'white',
                }}
                ...
                {/* <TouchableOpacity
                  style={{
                   ...
                   marginTop: '3%',
                   marginBottom: '3%',
                   borderWidth: selectedColor.includes('brown') ? 1 : 1,
                   borderColor: selectedColor.includes('brown') ? 'black' : 'white',
                }}
                  onPress={() => handleColorPress('brown')}
                ></TouchableOpacity>
                 */}
                {/* <TouchableOpacity
                  style={{
                   ...
                   marginTop: '3%',
                   marginBottom: '3%',
                   borderWidth: selectedColor.includes('green') ? 1 : 1,
                   borderColor: selectedColor.includes('green') ? 'black' : 'white',
                }}
                  onPress={() => handleColorPress('green')}
                ></TouchableOpacity> */}
                ...
                {/* <TouchableOpacity
                  style={{
                   ...
                   marginTop: '3%',
                   marginBottom: '3%',
                   borderWidth: selectedColor.includes('orange') ? 1 : 1,
                   borderColor: selectedColor.includes('orange') ? 'black' : 'white',
                }}
                  onPress={() => handleColorPress('orange')}
                ></TouchableOpacity> */}
                </View>
              ...
              <View style={{}}>
                ...
                <View style={{flexDirection:'row',marginLeft:'-1%'}}>
                     ...
                     <View style={{}}>
                        ...
                        <View style={{width:'70%'}}>
                       <Text style={styles.detail3}>{product.country}</Text>
                        <Text style={styles.detail3}>{product.wearType}</Text>
                        <Text style={styles.detail3}>{product.fabric}</Text>
                        <Text style={styles.detail3}>{product.sleeves}</Text>
                        <Text style={styles.detail3}>{product.fit}</Text>
                        <Text style={styles.detail3}>{product.materialCare}</Text>
                     </View>
                </View>
...
>
  ...
  <View>
    <Text style={{padding:'5%',marginTop:'14%'}}>{product.seller} is Modern jeans began to appear in the 1920s, but sales were largely confined to the working people of the western United States, such as cowboys, lumberjacks, and railroad workers.{product.seller} jeans apparently were first introduced to the East during the dude ranch craze of the 1930s, when vacationing Easterners returned home with tales (and usually examples) of the hard-wearing pants with rivets. Another boost came in World War II, when blue jeans were declared an essential commodity and were sold only to people engaged in defense work.</Text>
              ...
              <Text style={{fontWeight:'300',fontSize:12,marginLeft:'2%',padding:'1%'}}>Check availabilty at your nearest store</Text>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <TextInput
          style={{
            borderWidth: 0.2,
        ...
        {
          pinError?
          <Text style={{color:'red',marginLeft:'3%'}}>Please enter pincode</Text>:
          <Text></Text>
        }
        { 
         checkproductAvailabilityAtPincode?
         <Text style={{color:'#00A3A1',marginLeft:'2%',marginBottom:'4%'}}>Product is available on this pincode</Text>
          :
          <Text style={{color:'red',marginLeft:'2%',marginBottom:'4%'}}>Sorry Product is not available on this pincode</Text>
        }
        ...
        <View key={rating} style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          />
              ...
              <TouchableOpacity style={{marginTop:'7%', borderBottomWidth: 0.2, borderColor: 'grey', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}
                ...
                >
                <Text style={{ paddingLeft: '4%', fontWeight: '500', color: 'black', fontSize: 15, marginTop: '3%', padding: '1%', }}>More Jeans from this Brand</Text>
              ...
              <TouchableOpacity style={{ borderBottomWidth: 0.2, borderColor: 'grey', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}
                ...
                <Text style={{ paddingLeft: '4%', fontWeight: '500', color: 'black', fontSize: 15, marginTop: '3%', padding: '1%' }}>See More Jeans</Text>
                <Image source={next} style={{ width: 10, height: 10, marginRight: '4%' }}/>  
              </TouchableOpacity>
             </View>
           </View>
