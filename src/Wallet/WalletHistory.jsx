...
const WalletHistory = ({navigation}) => {
  ...
  const {transactionDetail, setTransactionDetail, selectedOption1} =
    useCartContext();
    ...
    try {
      ...
      const filteredData = response.data.filter(transaction => {
        ...
        const thirtyDaysAgo = new Date(
          currentDate.setDate(currentDate.getDate() - selectedOption1),
        );
    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <View style={{flexDirection: 'row', justifyContent: 'space-bewteen'}}>
        ...
        <TouchableOpacity
          ...
          <Image
            source={download}
            style={{width: 21, height: 21, marginLeft: '30%'}}
          />
        </TouchableOpacity>
      </View>
      <Modal
