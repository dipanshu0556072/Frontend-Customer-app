  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <View
        ...
        <Text style={{margin: '3%', color: 'white', fontSize: 14.6}}>
          Available Balance:
        </Text>
        <Text
          style={{
      ...
      <View
        style={{height: 3, backgroundColor: '#ebe8e8', marginTop: '0.7%'}}
      />
      <View
        style={{
          alignSelf: 'center',
          height: 30,
          width: '80%',
          backgroundColor: 'rgba(0, 163, 161, 0.5)',
          marginTop: '3%',
        }}>
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <Image
          ...
          <Text
            ...
            Use code ADD25 to win ₹25 cashback.
      ...
      <TouchableOpacity
        style={{
          backgroundColor: addedMoney ? '#00338D' : '#9c9898',
          width: '45%',
          padding: '3%',
          marginTop: '15%',
          alignSelf: 'center',
