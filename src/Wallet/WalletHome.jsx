...
const WalletHome = ({navigation}) => {
  ...
  const getData = async () => {
    try {
      const response = await axios.get(
        `http://${ip}:5454/api/wallet/history/${loginUserId}`,
        {
          headers: {
  ...
  const getFreezeData = async () => {
    try {
      const response = await axios.get(
        `http://${ip}:5454/api/wallet/total-freeze-amount?userId=${loginUserId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <ScrollView>
          ...
          <View style={{width: '68%', height: 200}}>
            ...
            <Text style={styles.walletInstruction}>
              ...
              <Text style={{fontWeight: '500'}}>
                {' '}
                ₹1,00,000.
                <Text style={{fontWeight: '800', color: '#0391da'}}>
                  {' '}
                  T&C applied.
                </Text>
              </Text>
          ...
          <View
            ...
            <View style={{alignItems: 'center', marginLeft: '4%'}}>
              <TouchableOpacity
                ...
                <Image
                  source={addMoney}
                  style={{width: 45, height: 45, margin: '14%'}}
                />
              </TouchableOpacity>
              <Text
                style={{color: '#00338D', fontSize: 16, textAlign: 'center'}}>
                Add {'\n'}Money
              </Text>
            </View>
            ...
            <View style={{alignItems: 'center', marginRight: '3%'}}>
              <View
                ...
                <Image
                  source={requestMoney}
                  style={{width: 40, height: 40, margin: '22%'}}
                />
              </View>
              <Text
                style={{color: '#00338D', fontSize: 16, textAlign: 'center'}}>
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => {
              forNavigate('walletHistory');
            }}>
            <LinearGradient
              colors={['#00338D', '#00A3A1']}
              style={{
                width: 195,
                height: 70,
                borderRadius: 12,
        ...
        <Image
          source={walletImage1}
          style={{width: 410, height: 240, alignSelf: 'center'}}
        />
        <Text
          style={{
            color: '#00338D',
          ...
          renderItem={({item}) => (
            <View
              ...
              <TouchableOpacity>
                <Image
                  source={item.image}
                  style={{width: 300, height: 150, borderRadius: 12}}
                />
                <Text
                  style={{
                    textAlign: 'center',
        ...
        />
        <View
          style={{height: 1.6, backgroundColor: '#00338D', marginBottom: 2}}
        />
        <View
          style={{height: 8, backgroundColor: '#f5f5f5', marginBottom: 10}}
        />
        ...
        <View
          ...
          <View style={{flexDirection: 'row', marginLeft: '4%'}}>
            <Image
              source={requestStatement}
              style={{width: 22, height: 22, marginRight: '6%'}}
            />
            <TouchableOpacity
              onPress={() => {
                forNavigate('requestStatement');
              }}>
              <Text style={{color: '#00338D', fontSize: 16, marginLeft: '5%'}}>
                Request Statement
              </Text>
            </TouchableOpacity>
          </View>
          <Image
            source={upperArrow}
            style={{width: 22, height: 12, transform: [{rotate: '-90deg'}]}}
          />
        </View>
        ...
        <View
          ...
          <View style={{flexDirection: 'row', marginLeft: '4%'}}>
            <Image
              source={automaticMoney}
              style={{width: 24, height: 24, marginRight: '6%'}}
            />
            <Text style={{color: '#00338D', fontSize: 16}}>
              Automatic Add Money to Wallet
            </Text>
          </View>
          <Image
            source={upperArrow}
        ...
        <View
          ...
          <View style={{flexDirection: 'row', marginLeft: '4%'}}>
            <Image
              source={spendAnalytics}
              style={{width: 24, height: 20, marginRight: '6%'}}
            />
            <Text style={{color: '#00338D', fontSize: 16, marginLeft: '3%'}}>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          <Text style={{margin: '4%', fontSize: 16, fontWeight: '500'}}>
       ...
       <Image source={filter} style={{width:20,height:20,marginLeft:'2%'}}/> */}
              ...
              return (
                <React.Fragment key={index}>
                  ...
                  <View
                    style={{
                      height: 6,
                      backgroundColor: 'rgba(0, 160, 161, 0.2)',
                      marginTop: '0.3%',
                    }}
                  />
                </React.Fragment>
        ...
        <View
          style={{height: 0.4, backgroundColor: '#00338D', marginBottom: '5%'}}
        />
      </ScrollView>
    </View>
  );
