    ...
    const data = [
      ...
      return (
        ...
        />   
         ...
         <View style={{width:'100%',height:140,marginTop:'2%'}}>
           <Image source={gold1} style={{width:'100%',height:140,}}/>
           <View style={{marginTop:'-28%'}}>
             <Text style={{color:'white',alignSelf:'center',fontWeight:'800',fontSize:19,textAlign:'center'}}>Celebrate Exclusive Savings! Enjoy a 3% Discount on All Brands Throughout Your Membership Validity.</Text>
           </View>
         </View>
         ...
         <View style={{width:'100%',height:140,backgroundColor:'#00338c',marginTop:'1%',marginBottom:'5%'}}>
           <Text style={{color:'white',fontWeight:'500',marginTop:'2%',fontSize:16,marginLeft:'4%'}}>How to be a Silver Tier Member</Text>
           <Text style={{color:'white',fontSize:16,margin:'4%',fontWeight:'300',fontSize:15}}>Start Shopping with KPMG Retail App now and {'\n'}spend between 
              <Text style={{fontWeight:'600',color:'white'}}> ₹ 100 to ₹ 999 </Text> in the last 12 {'\n'}
              <Text style={{textDecorationLine:'underline',color:'white'}}>months to enjoy the Silver Tier Member Benefits</Text> </Text>
         </View>         
        </ScrollView>
      </View>  )
}
