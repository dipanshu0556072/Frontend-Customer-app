...
const PlatinumTier = ({navigation}) => {
    const data = [
        { id: '1', source: platinum,title1:'',title2:'',title3:'',title4:'',title5:'',title6:''},
       ...
       <FlatList
         ...
         <View style={{ position: 'relative' }}>
           ...
           <View style={{ position: 'absolute', top: '89%', left: 0, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ color: 'white' ,fontSize:20,fontWeight:'600'}}>PLATINUM TIER</Text>
          </View>
       </View>
  )}
/>
       ...
       <View style={{width:'100%',height:140,marginTop:'1%'}}>
         ...
         <View style={{marginTop:'-28%'}}>
             <Text style={{color:'white',alignSelf:'center',fontWeight:'800',fontSize:19,textAlign:'center'}}>Celebrate Exclusive Savings! Enjoy a 12% Discount on All Brands Throughout Your Membership Validity.</Text>
         </View>
       </View>
       <View style={{width:'100%',height:140,marginTop:'1%'}}>
       ...
       <View style={{width:'100%',height:140,backgroundColor:'#00338c',marginTop:'1%',marginBottom:'5%'}}>
         <Text style={{color:'white',fontWeight:'500',marginTop:'2%',fontSize:16,marginLeft:'4%'}}>How to be a Platinum Tier Member</Text>
         <Text style={{color:'white',fontSize:16,margin:'4%',fontWeight:'300',fontSize:15}}>Start Shopping with KPMG Retail App now and {'\n'}spend between 
            <Text style={{fontWeight:'600',color:'white'}}> ₹ 5,000 to ₹ 49,999 </Text> in the last 12 {'\n'}
            <Text style={{textDecorationLine:'underline',color:'white'}}>months to enjoy the Platinum Tier Member Benefits</Text> </Text>
       </View>         
      </ScrollView>
    </View>  )
}
