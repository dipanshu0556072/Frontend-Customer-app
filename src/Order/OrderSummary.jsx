...
/> */}
          ...
          {allSavedAddress && allSavedAddress.length <= 0 && (
            <>
              <Image
                source={Address}
                style={{width: 400, height: 220, marginTop: '23%'}}
              />
            </>
          )}
          {isDropdownOpen && (
                ...
                <View key={addressIndex} style={{padding: '1%'}}>
                  <TouchableOpacity
                    style={{
                      borderWidth: 1,
                      borderColor:
                        selectedAddress === addressIndex ? '#00338D' : 'grey',
                      marginLeft: '4%',
                      marginRight: '4%',
                      padding: '4%',
                      flexDirection: 'row',
                      ...
                      {selectedAddress === addressIndex && (
                        <>
                          ...
                          <TouchableOpacity
                            ...
                            onPress={() => {
                              forNavigate1('AddressDetail', address.id, true);
                            }}>
                            <Text
                              style={{color: '#00338D', textAlign: 'center'}}>
                              Edit address
                            </Text>
                          </TouchableOpacity>
                        </>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              forNavigate1('AddressDetail', -1, false);
            }}>
