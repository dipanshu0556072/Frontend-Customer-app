...
const ShopTrack = ({navigation}) => {
  ...
  totalQuantity =
    trackCurrentOrder &&
    trackCurrentOrder.orderItems &&
    trackCurrentOrder.orderItems.length
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text style={{color: '#00A3A1', fontSize: 16}}>
              CONTINUE SHOPPING
            </Text>
          </TouchableOpacity>
        ...
        <View style={styles.confirmOrderBox}>
          ...
          <Text style={styles.confirmOrderUserNameText1}>
            Hey {updateUserName},
          </Text>
          <Text style={styles.confirmOrderUserNameText2}>
            Your Order is Confirmed!
          </Text>
          <Text style={styles.confirmOrderUserNameText3}>
            We'll send you a shipping confirmation email{'\n'}as soon as your
            order ships.
          </Text>
        </View>
        <TouchableOpacity
          style={styles.checkOrderStatusBtn}
          onPress={() => {
            forNavigate('order');
          }}>
        ...
        <View
          style={{backgroundColor: '#00338D', height: 0.3, marginTop: '4%'}}
        />
