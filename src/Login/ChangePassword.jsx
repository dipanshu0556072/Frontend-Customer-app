      ...
      if (newPassword !== confirmPassword) {
        ...
        try {
          const response = await axios.put(
            `http://${ip}:5454/api/users/change-password/${loginUserId}?currentPassword=${currentPassword}&newPassword=${newPassword}`,
            null,
            {
              headers: {
  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <Image
          source={padlock}
          style={{alignSelf: 'center', width: 30, height: 30, marginTop: '4%'}}
        />
        <Text
          style={{
            fontSize: 24,
        ...
        <Text style={{color: '#00338D', textAlign: 'center', fontSize: 13}}>
        ...
        <View
          ...
          {seePassword1 ? (
            <TouchableOpacity onPress={Eye}>
              <Image
                source={eye2}
                style={{width: 21, height: 18, marginTop: 40, marginRight: 74}}
              />
            </TouchableOpacity>
          ) : (
        ...
        <View
          ...
          <Image
            source={lock}
            style={{width: 22, height: 20, marginLeft: '3%', padding: '2%'}}
          />
          <TextInput
            style={{
              borderBottomWidth: 0.6,
          ...
          {seePassword2 ? (
            <TouchableOpacity onPress={Eye1}>
              <Image
                source={eye2}
                style={{width: 21, height: 18, marginTop: 10, marginRight: 94}}
              />
            </TouchableOpacity>
          ) : (
        ...
        {newPassConfirmPassMatch ? (
          <Text
            ...
            New password & confirm not matched
          </Text>
        ) : (
        ...
        {passwordChanged ? (
          <Text
            style={{color: 'green', fontWeight: '600', textAlign: 'center'}}>
